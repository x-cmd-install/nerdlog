...
[![x-cmd/install — nerdlog Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/nerdlog.svg?lang=zh)](https://x-cmd.com/install/nerdlog)
...
合计: **21,706** 行代码（覆盖前 5 种语言、共 **169** 个文件）。
...
- **官网**: <https://dmitryfrank.com/projects/nerdlog/article>
- **许可证**: BSD-2-Clause
...
- **Star**: 1,563 · **Fork**: 40 · **开放 issue**: 31 · **贡献者**: 2

## 累计统计

- **发布数**: 19 · **已合并 PR**: 20 · **开放 PR**: 1 · **已关闭 issue**: 20 · **开放 issue**: 11 · **提交数**: 487

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 1 | 0 | 1 | 1 | 0 | 20 |
| last60d | 2026-07-25 | 1 | 0 | 1 | 1 | 0 | 20 |
| 90d | 2026-06-25 | 1 | 0 | 1 | 1 | 0 | 20 |
| last180d | 2026-03-27 | 1 | 0 | 1 | 1 | 0 | 20 |
| 360d | 2025-09-28 | 1 | 0 | 1 | 1 | 0 | 20 |
| last720d | 2024-10-03 | 19 | 20 | 1 | 20 | 11 | 322 |
...
nerdlog 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `nerdlog` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/nerdlog.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T03:41:13Z._
